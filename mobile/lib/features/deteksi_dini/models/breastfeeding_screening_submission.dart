class BreastfeedingScreeningSubmission {
  const BreastfeedingScreeningSubmission({
    required this.id,
  ...
  factory BreastfeedingScreeningSubmission.fromJson(Map<String, dynamic> json) {
    return BreastfeedingScreeningSubmission(
      id: json['id'] as int,
