...
use App\Http\Requests\Api\EvaluateBreastfeedingRequest;
...
class BreastfeedingCalculatorEvaluateController extends Controller
{
	public function __construct(
		private readonly BreastfeedingScreeningSubmissionService $submissionService,
	) {}

	public function evaluate(EvaluateBreastfeedingRequest $request): JsonResponse
	{
		try {
