...
use App\Http\Requests\Api\StoreAnemiaScreeningSubmissionRequest;
...
class AnemiaScreeningSubmissionController extends Controller
{
	...
	public function store(StoreAnemiaScreeningSubmissionRequest $request): JsonResponse
	{
		try {
