...
class UpdateAnjuranStatusGiziRequest extends FormRequest
{
	...
	public function rules(): array
	{
		return [
			...
			'anjuran_rules.*.indicator' => ['required', Rule::in([
	...
	public function resolveItem(): EducationItem
	{
	...
	public function attributes(): array
	{
		return [
			...
			'anjuran_rules.*.indicator' => 'indikator z-score',
		];
	}
}
