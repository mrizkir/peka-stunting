<x-layouts.app
  ...
  heading="Anjuran LILA"
  description="Kelola aturan anjuran hasil skrining LILA per kelompok kebutuhan (menu edukasi)."
>
  @if (session('success'))
          ...
          @forelse ($entries as $entry)
            <tr class="border-b border-base-200 last:border-0">
              ...
              <td class="px-4 py-3 text-right">
                <a
                  href="{{ route('anjuran-lila.edit', $entry['menu_slug']) }}"
          ...
          @empty
            <tr>
              <td colspan="5" class="px-4 py-8 text-center text-base-content/60">
                Belum ada konten Cek LILA. Jalankan seeder edukasi terlebih dahulu.
              </td>
            </tr>
          @endforelse
        </tbody>
